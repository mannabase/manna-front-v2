...
export let claimMannaContractABI = [
    {
        anonymous: false,
        inputs: [
            {
        ...
        inputs: [
            {
                ...
                internalType: 'struct CheckinSignature[]',
                name: 'sigs',
                type: 'tuple[]',
            },
        ],
    ...
    {
        inputs: [
            { internalType: 'address', name: 'mannaAddr', type: 'address' },
            {
                internalType: 'address',
    ...
    },
    {
        ...
        name: 'mannaToken',
        outputs: [
            { internalType: 'contract IManna', name: '', type: 'address' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        inputs: [
            { internalType: 'uint256', name: 'maxClaimable_', type: 'uint256' },
        ],
    ...
    },
    {
        inputs: [
            { internalType: 'uint256', name: 'score', type: 'uint256' },
            {
                ...
                internalType: 'struct VerificationSignature',
                name: 'sig',
                type: 'tuple',
            },
        ],
...
// export let serverUrl = 'https://mn.zxcode.xyz/backend';
// export let serverUrl = 'http://backend:7231';
export let serverUrl = 'https://mannabase.com/backend';
